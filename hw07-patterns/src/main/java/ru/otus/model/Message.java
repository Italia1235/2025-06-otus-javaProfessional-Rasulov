...
public class Message {
    ...
    public Builder toBuilder() {
        ...
        if (this.field13 != null) {
            field13Copy = this.field13.copy();
        }
        return new Builder(id, field1, field2, field3, field4, field5, field6, field7, field8, field9, field10, field11, field12, field13Copy);
    }
